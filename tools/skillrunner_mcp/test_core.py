# -*- coding: utf-8 -*-
"""SkillRunner self-check (Excel 불필요 — Mac/Windows 공통).
...
from skillrunner import runner_core as core  # noqa: E402
...
class McpClient:
    ...
    def __init__(self):
        self.proc = subprocess.Popen(
            [sys.executable, "-m", "skillrunner.mcp_server"],
...
def test_mcp_protocol_and_lifecycle():
    ...
    try:
        ...
        assert init["result"]["serverInfo"]["name"] == "skillrunner", init
