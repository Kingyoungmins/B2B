...
set "PACKAGE_DIR=dist\B2B_ver0.5.5"
set "PAYLOAD=build\b2b_ver055_single_payload.zip"
set "OUT_EXE=dist\B2B_ver0.5.5_single.exe"
set "CSC=%WINDIR%\Microsoft.NET\Framework64\v4.0.30319\csc.exe"

echo ============================================
echo  B2B ver0.5.5 single EXE wrapper build
echo ============================================
echo.

if not exist "%PACKAGE_DIR%\B2B_ver0.5.5.exe" (
    echo [ERROR] Missing %PACKAGE_DIR%\B2B_ver0.5.5.exe
