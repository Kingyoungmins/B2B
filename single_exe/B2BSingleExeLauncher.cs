...
namespace B2BSingleExe
{
    ...
    {
        private const string Version = "0.6.1.a";
        private const string ResourceName = "payload.zip";
        private const string MainExeName = "B2B_ver0.6.1.a.exe";
        ...
        private static int Main(string[] args)
        {
            try
            {
                ...
                string extractDir = Path.Combine(
                    Path.GetTempPath(),
                    "B2B_ver0.6.1.a_single_" + Process.GetCurrentProcess().Id + "_" + DateTime.UtcNow.Ticks
                );
