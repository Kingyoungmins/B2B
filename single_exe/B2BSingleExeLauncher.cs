...
namespace B2BSingleExe
{
    ...
    {
        private const string Version = "0.5.15.1";
        private const string ResourceName = "payload.zip";
        private const string MainExeName = "B2B_ver0.5.15.1.exe";
        ...
        private static int Main(string[] args)
        {
            try
            {
                ...
                string extractDir = Path.Combine(
                    Path.GetTempPath(),
                    "B2B_ver0.5.15.1_single_" + Process.GetCurrentProcess().Id + "_" + DateTime.UtcNow.Ticks
                );
