/* ===================================================================
   CONFIG
   =================================================================== */
const KGM_BUILD_STAMP = "ver3.7.1-violet-url-20260529-1";
...
const DEFAULTS = {
  ...
  "openai-compat": {
    ...
    violetBaseUrl: "http://canvas-ns-1727666527880704.mng.ip.violet.uplus.co.kr",
    thinkMode: false,
...
const SETTINGS_KEY = "mvno_llm_settings_v371";
...
function normalizeSettings(parsed) {
  ...
  if (parsed.provider === "openai-compat") {
    return {
      ...
      violetBaseUrl: parsed.violetBaseUrl || DEFAULTS["openai-compat"].violetBaseUrl,
