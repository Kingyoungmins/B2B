...
### ver3.7.1
- AI 연결 설정에 Violet 실제 주소 (프록시 대상) 입력칸을 추가했습니다.
- 기존 Base URL은 브라우저가 호출하는 로컬 프록시 주소로 유지하고, 새 violet 주소는 서버의 /v1/* 프록시 upstream으로 사용합니다.
- EXE 빌드 결과 파일명은 KGM_B2B_ver3.7.1.exe입니다.
...
- EXE 빌드 결과 파일명은 `KGM_B2B_ver3.7.exe`입니다.
