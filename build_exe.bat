...
set "APP_VERSION=0.4.13.1"
set "SERVER_EXE=B2B_Server.exe"
set "PACKAGE_DIR=dist\B2B_ver0.4.13.1"
set "PACKAGE_ZIP=dist\B2B_ver0.4.13.1_portable.zip"
...
mkdir "%PACKAGE_DIR%"
copy /y "native_host\bin\B2B_NativeHost.exe" "%PACKAGE_DIR%\B2B_ver0.4.13.1.exe" >nul
...
if not exist "%PACKAGE_DIR%\B2B_ver0.4.13.1.exe" (
...
echo ============================================
echo  Build complete
echo  EXE: %PACKAGE_DIR%\B2B_ver0.4.13.1.exe
