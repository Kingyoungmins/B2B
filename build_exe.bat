...
set "PACKAGE_ZIP=dist\B2B_ver0.5.7_portable.zip"
...
mkdir "%PACKAGE_DIR%"
copy /y "native_host\bin\B2B_NativeHost.exe" "%PACKAGE_DIR%\B2B_ver0.5.7.exe" >nul
...
echo ============================================
echo  Build complete
echo  EXE: %PACKAGE_DIR%\B2B_ver0.5.7.exe
