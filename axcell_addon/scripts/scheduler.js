...
(function () {
  ...
  function bind() {
    ...
    root.addEventListener("drop", (e) => {
      ...
      if (card && state.skill) loadTrace(card.dataset.doc, file);
      else if (!state.skill || e.target.closest(".sx-step")) loadSkill(file);
    });
  ...
  function bindList() {
    ...
    root.addEventListener("click", (e) => {
      ...
      if (act === "edit") {
        ...
        list.draft = {
          name: item.skillName,
          cycle: base.cycle || "monthly", day: base.day || 1, weekday: base.weekday || 1,
