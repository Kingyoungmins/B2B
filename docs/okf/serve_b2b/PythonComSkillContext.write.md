...
- 피호출(영향 전파 경로): `B2BHandler.handle_backend_download`, `B2BHandler.handle_workbook_source_download`, `B2BHandler.handle_workbook_upload`, `B2BHandler.proxy`, `B2BHandler.send_json`, `PythonComSkillContext.add_total_row`, `PythonComSkillContext.filter_to_sheet`, `PythonComSkillContext.lookup`, `PythonComSkillContext.pivot`, `PythonComSkillContext.split_column`, `PythonComSkillContext.write_cell`, `_diag_prerun_window_state`, `_diag_vba_log_line`, `_diag_vba_run_failure`, `_perf_trace`, `_vba_trace`, `build_workbook_archive`, `node_worker_command`, `run_js_pipeline_with_node`
