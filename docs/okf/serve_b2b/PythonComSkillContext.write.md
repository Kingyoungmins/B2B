...
signature: "(self, sheet, a1_start, values, overwrite_formulas=True, skip_none_rows=True)"
role: "2차원 리스트를 시작 셀 기준으로 쓴다(연속 구간별 COM 소수회)."
role_source: docstring
version: "0.8.4"
loc: "serve_b2b.py:13204-13265"
...
## 관계
- 호출: `Cells`, `_apply_com_text_format_for_long_digit_columns`, `_as_2d`, `_journal_save`, `_resize_rng`, `_rng`, `_tick`, `_vba_trace`, `_ws`, `rows`, `sheet`, `values`
