...
## 관계
- 호출: `book`
- 피호출(영향 전파 경로): `PythonComSkillContext.copy`, `PythonComSkillContext.copy_key_blocks`, `PythonComSkillContext.copy_values`, `PythonComSkillContext.sum_lookup`
