...
## 관계
- 호출: `Worksheets`, `_allow_read_only_mirror_selection`, `_configure_read_only_mirror_input_block`, `_disable_excel_context_menus`, `_show_excel_formula_bar`, `range`
