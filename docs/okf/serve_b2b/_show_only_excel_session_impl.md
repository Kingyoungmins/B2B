---
type: function
title: _show_only_excel_session_impl
module: serve_b2b.py
lang: python
extraction: ast
...
## 관계
- 호출: `_capture_browser_hwnd`, `_hide_peer_workbook_windows`, `_position_excel_window`, `_present_live_session_frame`, `_safe_activate_excel_app`, `_set_excel_window_owner`, `_show_workbook_window`, `get_excel_session`, `session_workbook`
- 피호출(영향 전파 경로): `show_only_excel_session`
