...
lang: python
extraction: ast
signature: "(wb, max_rows=60, max_cols=_SNAPSHOT_MAX_COLS)"
role: "라이브 적용 후 클라 스키마 캐시 갱신용 경량 미리보기(시트명 + 상위 N행 AoA + 차원)."
role_source: docstring
version: "0.5.18"
loc: "serve_b2b.py:10610-10633"
...
- 피호출(영향 전파 경로): `_run_full_pipeline_single_instance_impl`, `_run_python_on_session_impl`, `_run_vba_on_session_impl`, `_run_vba_pipeline_on_session_impl`
