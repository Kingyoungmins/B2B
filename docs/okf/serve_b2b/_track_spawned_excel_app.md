...
- 피호출(영향 전파 경로): `_diag_vba_run_failure`, `_get_live_excel_app`, `_get_python_skill_app`, `_open_excel_session_impl`, `_reopen_excel_session_workbook`, `_run_full_pipeline_single_instance_impl`, `_setup_isolated_pipeline_instance`, `inspect_workbook_with_excel`, `load_workbook_aoa_with_excel`
