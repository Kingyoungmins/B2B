...
## 관계
- 호출: `_disable_vba_break_on_all_errors`, `_excel_process_id`, `_extract_vba_source_for_injection`, `_hide_vba_editor`, `_inject_and_run_vba_in_host`, `_is_vba_macro_run_blocked_error`, `_normalize_vba_llm_comment_slips`, `_normalize_vba_workbook_literals`, `_restore_foreground_after_vba`, `_run_vba_via_runner_with_retry`, `_start_vba_debug_suppressor`, `_strip_empty_vba_loops`, `_suppress_vba_debug_windows`, `_trace_hash`, `_trace_text`, `_trace_workbook_info`, `_validate_vba_source_before_inject`, `_vba_should_use_runner_host`, `_vba_trace`
