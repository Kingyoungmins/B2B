---
type: endpoint
title: activateCurrentSelectionInExcel
...
## 관계
- 호출: `currentExcelAddress`, `currentExcelId`, `openCurrentWorkbookInExcel`, `pollExcelMirrorChanges`, `postExcelMirror`, `suppressExcelMirrorSelection`, `updateMirrorShellStatus`
- 피호출(영향 전파 경로): 없음
