...
## 관계
- 호출: 없음
- 피호출(영향 전파 경로): `_ensureExcelCancelButton`, `_reapplyVbaPipelineToLiveImpl`, `_reportProgress`, `_setOverlayProgress`, `beginExcelMirrorApplyLoading`
