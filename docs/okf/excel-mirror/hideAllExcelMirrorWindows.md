...
- 피호출(영향 전파 경로): `applyVbaStepToLiveExcel`, `beginExcelMirrorApplyLoading`, `reapplyVbaPipelineToLive`, `runLivePipelineStepSequentially`, `selectFallbackFileAfterRemoval`, `setPage`
