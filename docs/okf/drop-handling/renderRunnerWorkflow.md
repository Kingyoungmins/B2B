...
role_source: none
version: "0.8.1"
loc: "drop-handling.js:1995-1995"
...
## 관계
- 호출: `$`, `add`, `collectAllDownloadFiles`, `escapeHtml`, `getFile`, `isStepEnabled`, `openRunnerFileEditor`, `openRunnerLogicEditor`, `runnerMappingHasBlockingMissing`, `runnerRenderMappingPanel`, `runnerResetMappingIfSourceChanged`, `setCount`, `setNodeStatus`, `toggle`
