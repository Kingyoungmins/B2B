---
type: endpoint
title: restorePipelineCheckpointForSuffix
module: pipeline.js
lang: js
...
- 피호출(영향 전파 경로): `restorePipelineToCheckpointAndHold`, `runFromCheckpointAfterEdit`, `runPipelineWithAutoRepair`
