---
type: endpoint
title: _reconcilePipelineSimulationAfterEditImpl
module: pipeline.js
lang: js
...
## 관계
- 호출: `affectedStepViewFileId`, `affectedStepViewSheetHint`, `clearPipelineExecutionMemory`, `crossOutputFileIdsReferencedInCode`, `crossWriteDestinationFileIds`, `ensurePinnedVbaTargetExcelId`, `excelIdForPipelineFileId`, `getSkillEngine`, `hasBackendOnlyWorkbooks`, `inferPipelineStepLanguage`, `isStepEnabled`, `liveEnabledStepsSignature`, `pipelineHasBackendOnlyStep`, `pipelineHasUnresolvedTarget`, `pipelinePinnedTargetFileId`, `pipelineStepLiveLanguage`, `pipelineUsesPython`, `preferredVbaRunFileId`, `push`, `reapplyVbaPipelineToLive`, `refreshTabs`, `renderExcelViewer`, `runPipeline`, `runPipelinePreferBackend`, `shouldDeferImmediatePipelineRun`, `shouldUseFastPreviewPipelineRun`, `toast`, `vbaTargetExcelId`, `warnUnresolvedPipelineTarget`
- 피호출(영향 전파 경로): `reconcilePipelineSimulationAfterEdit`
