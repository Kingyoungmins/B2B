...
- 피호출(영향 전파 경로): `bindPipelineStepTargetContext`, `isolatedPipelineStepPayload`, `localRepairActiveSheetUsedRangeFormatVba`, `reapplyVbaPipelineToLive`
