...
- 피호출(영향 전파 경로): `applyLastEnabledStepFast`, `ensureVbaRunExcelId`, `reconcilePipelineSimulationAfterEdit`, `restoreLastStepPreApplySnapshot`, `runIsolatedLivePipelineSteps`, `runPipelineSuffixFromCheckpoint`, `runVbaPipelinePreferLive`
