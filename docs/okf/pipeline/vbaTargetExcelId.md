...
## 관계
- 호출: `currentExcelId`
- 피호출(영향 전파 경로): `applyLogic`, `ensureVbaRunExcelId`, `insertLogic`, `reconcilePipelineSimulationAfterEdit`, `replaceLogicAt`, `requestExcelApplyCancel`, `runPipelineSuffixFromCheckpoint`, `runVbaPipelinePreferLive`
