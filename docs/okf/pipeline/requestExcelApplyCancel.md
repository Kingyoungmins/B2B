...
## 관계
- 호출: `reapplyVbaPipelineToLive`, `refreshRunButton`, `renderPipeline`, `setPipelineRuntimeStatus`, `toast`, `vbaTargetExcelId`
- 피호출(영향 전파 경로): `_ensureExcelCancelButton`, `applyVbaStepToLiveExcel`, `beginExcelMirrorApplyLoading`, `insertLogic`, `replaceLogicAt`
