...
- 피호출(영향 전파 경로): `applyLastEnabledStepFast`, `applyVbaStepToLiveExcel`, `reapplyVbaPipelineToLive`, `renderPipeline`, `restorePipelineToCheckpointAndHold`, `runIsolatedLivePipelineSteps`, `runPipelineSuffixFromCheckpoint`
