---
type: endpoint
title: buildStaticSafetyRegenPrompt
module: chat-ui.js
lang: js
...
## 관계
- 호출: `conditionalRowDeleteVbaHint`, `duplicateRowDeleteVbaHint`, `exactSheetNameReminder`, `filterToNewSheetVbaHint`
