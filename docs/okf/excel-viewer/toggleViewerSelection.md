---
type: endpoint
title: toggleViewerSelection
module: excel-viewer.js
lang: js
extraction: regex   # 정규식 근사
signature: "(viewer, ctx, range)"
role: "(추정) 역할 주석 없음 — 담당자 1줄 보완 필요"   # (추정)
role_source: none
version: "0.7.3"
loc: "excel-viewer.js:676-676"
...
## 관계
- 호출: `normalizeRange`, `paintViewerSelections`, `rangesEqual`, `updateChatRangeReference`
